...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Add New Post <a href="{{ route('posts_own') }}" class="btn btn-danger float-right btn-sm">Cancel</a></div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('posts_create_post') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="details" class="form-control @error('details') is-invalid @enderror" name="details" required>{{ old('details') }}</textarea>
