...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Update Post <a href="{{ route( 'posts_modification' ) }}" class="btn btn-danger float-right btn-sm">Cancel</a></div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('posts_modification_detail_post', ['id' => $post->id]) }}">
                            @csrf
